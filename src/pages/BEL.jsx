...
// import Projects from '../components/Device.jsx';
import PhoneDark from '../components/devices/PhoneDark.jsx';
import Nav from '../components/Nav.jsx';


// get images, create text, config page layout
    ...
    <>
      ...
      <section className="bg-[#185977]">
        <div className="panel two-column-layout">
          {/* Left column */}
          <div>
            <h2 className="mb-6 text-white">Black Entertainment Locator</h2>
            <p className="text-white">BEL text goes here...</p>
          </div>
